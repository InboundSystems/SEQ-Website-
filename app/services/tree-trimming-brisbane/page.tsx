  ...
  return (
    <>
      ...
      <ServicePageLayout h1="Tree Trimming Brisbane" breadcrumbs={breadcrumbs} ctaServiceName="Tree Trimming" relatedServices={relatedServices}>
        ...
        <section className="py-10">
          <FadeIn>
            <h2 className="text-2xl sm:text-3xl font-bold mb-6" style={{ color: '#1C3A2A', fontFamily: 'var(--font-playfair), Georgia, serif' }}>Why Brisbane Homeowners Choose SEQ Landscaping for Tree Trimming</h2>
            <ul className="space-y-3">
              {reasons.map((r) => (
