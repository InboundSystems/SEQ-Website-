  ...
  return (
    <>
      ...
      <ServicePageLayout h1="Green Waste Removal Brisbane" breadcrumbs={breadcrumbs} ctaServiceName="Green Waste Removal" relatedServices={relatedServices}>
        ...
        <section className="py-10">
          <FadeIn>
            <h2 className="text-2xl sm:text-3xl font-bold mb-6" style={{ color: '#1C3A2A', fontFamily: 'var(--font-playfair), Georgia, serif' }}>Why Brisbane Homeowners Choose SEQ Landscaping and Garden Maintenance for Green Waste Removal</h2>
            <ul className="space-y-3">
              {reasons.map((r) => (
