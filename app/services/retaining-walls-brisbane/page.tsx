  ...
  return (
    <>
      ...
      <ServicePageLayout h1="Retaining Walls Brisbane" breadcrumbs={breadcrumbs} ctaServiceName="Retaining Wall" relatedServices={relatedServices}>
        ...
        <section style={{ backgroundColor: '#F5F0E8' }} className="py-10 px-8 rounded-2xl">
          <FadeIn>
            <h2 className="text-2xl sm:text-3xl font-bold mb-6" style={{ color: '#1C3A2A', fontFamily: 'var(--font-playfair), Georgia, serif' }}>Why Brisbane Homeowners Choose SEQ Landscaping and Garden Maintenance for Retaining Walls</h2>
            <ul className="space-y-3">
              {reasons.map((r) => (
